...
import net.ptnetwork.common.enums.BusinessStatus;
import net.ptnetwork.common.enums.HttpMethod;
import net.ptnetwork.common.utils.ServletUtils;
import net.ptnetwork.common.utils.ip.IpUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(net.ptnetwork.common.annotation.Log)")
